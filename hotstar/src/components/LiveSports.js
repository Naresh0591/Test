...
const SPORTS_DATA = [
  {
    ...
    match: "MI vs CSK",
    status: "Mumbai Indians 186/4 (18.2 ov)",
    color: "#1a6cff",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    live: false,
    emoji: "🏎️",
    league: "Formula 1 · British GP",
    match: "Qualifying Session",
    status: "Saturday, 7:00 PM IST",
    color: "#e74c3c",
  },
  {
    id: 5,
    ...
    emoji: "🏀",
    league: "NBA Finals",
    match: "Celtics vs Mavericks",
    status: "Tonight, 8:00 AM IST",
    color: "#f39c12",
  },
];
